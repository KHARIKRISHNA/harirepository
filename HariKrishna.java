...
public class  HariKrishna {
	public static void main(String[] a) {
		...
		Person obj1=new Person("krishna","VVIT,Nambur");
		System.out.println(obj1.toString());

		Student obj2=new Student("krishna","VVIT,NAMBUR","B.Tech",3,812340.00);
		System.out.println(obj2.toString());

		Staff obj3=new Staff("krishna","Vvit, nambur","sksmc",3762.35);
